...
public class AlliumWireBlock extends Block {
    public static final MapCodec<AlliumWireBlock> CODEC = createCodec(AlliumWireBlock::new);
    ...
    @Override
    public MapCodec<AlliumWireBlock> getCodec() {
        return CODEC;
    }

    public AlliumWireBlock(AbstractBlock.Settings settings) {
        super(settings);
